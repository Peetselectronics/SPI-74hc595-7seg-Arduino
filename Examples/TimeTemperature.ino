...
//And parts of thermistor code is cmming from https://playground.arduino.cc/ComponentLib/Thermistor2
//
//          AAAA         Q0Q0Q0
//         F    B       Q5    Q1
//         F    B       Q5    Q1
...
long int timestamp = 1532087367  ; // 07/07/2018 @ 5:54pm (UTC)
...
float vcc = 4.98;                       
float pad = 11000; // Resistor value
...
void loop() {
  ...
  if(second() > 30){ 
    ...
    temp2 = (int)temp * 100;
    temp3 = (temp * 100) - (int)temp2;
    int temp_out = temp2 + temp3;
    
     Refresh_Display_int(temp_out, 2); 
     delay(10);
  }
